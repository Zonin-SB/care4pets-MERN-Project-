...
router.get('/api/getExpertChangeRejected/:id',auth.userAuth,userController.getExpertChangeRejected)
router.get('/api/getExpertChangeApproved/:id',auth.userAuth,userController.getExpertChangeApproved)
router.get('/api/getExpertChangeNotification/:id',auth.userAuth,userController.getExpertChangeNotification)
router.get('/api/userExpertRejectionAccepted/:id',auth.userAuth,userController.userExpertRejectionAccepted)
router.get('/api/userExpertChangeAccepted/:id',auth.userAuth,userController.userExpertChangeAccepted)

  ...
  return (
    <div className="max-w-screen-2xl mx-auto">
      <section className="max-w-4xl p-6 mx-auto bg-teal-900 rounded-md shadow-md dark:bg-gray-800 mt-20">
        <h1 className="text-4xl font-bold text-white capitalize dark:text-white flex justify-center">
          Expert Signup
        </h1>
          ...
          <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
            ...
            <div>
              ...
              <select
                ...
                onChange={handleChange}
                onBlur={handleBlur}
                className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-teal-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"
              >

  ...
  <nav className="nav-color">
        ...
        <div className="flex items-center">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-4">
              ...
              <button className=" hover:bg-gray-700 hover:text-white text-black-300 px-3 py-2 rounded-md text-sm font-medium" aria-current="page">Home</button>

              <button className="text-black-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Clients</button>
        ...
        <div className="hidden md:block">
          <div className="ml-4 flex items-center md:ml-6">
            ...
            <div className="relative ml-3">
              <div>
                <button onClick={logout} type="button" className='rounded-full py-2 px-3 text-xs font-bold cursor-pointer tracking-wider border-blue-900 border-2 text-blue-900 hover:bg-blue-900 hover:text-white'>
                  Logout
                </button>
              </div>
    ...
    <div className="md:hidden" id="mobile-menu">
      <div className="space-y-1 px-2 pt-2 pb-3 sm:px-3">
         {/* Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white"  */}
        <button  className=" text-gray-300 block hover:bg-gray-700 px-3 py-2 rounded-md text-base font-medium" aria-current="page">Home</button>

        <button  className="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Clients</button>

        <button  className="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Chat</button>

        <button  className="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Profile</button>

        ...
        <div className="flex items-center">
          ...
          <div class="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-4">
              ...
              <button className=" hover:bg-teal-800 hover:text-white text-black-300 px-3 py-2 rounded-md text-sm font-bold" aria-current="page">Home</button>
        ...
        <div className="hidden md:block">
          <div className="ml-4 flex items-center md:ml-6">
            ...
            <div className="relative ml-3">
              <div>
                <button type="button" className='rounded-full py-2 px-3 text-xs font-bold cursor-pointer tracking-wider border-blue-900 border-2 text-blue-900 hover:bg-blue-900 hover:text-white'>

...
import { rejectionMessageSchema } from '../../Validation/Validation';

function AdminRejectExpertPage() {
  ...
  const { values, errors, touched, handleBlur, handleChange, handleSubmit } =
    useFormik({
      ...
      validationSchema: rejectionMessageSchema,
      onSubmit,
...
export default AdminRejectExpertPage;

...
import { getFeedbackDetails } from '../../Axios/Services/AdminServices';

function AdminFeedbackExpandPage() {
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      ...
      const data = await getFeedbackDetails(token, id);
  ...
  return (
    <div className='max-w-screen-2xl mx-auto'>
      <>
        ...
        />
        {/* card container */}
        <div className="container px-4 sm:px-8 mx-auto max-w-lg mt-11">
          {/* card wrapper */}
          <div className="wrapper bg-white rounded-sm shadow-lg">
            <div className="card px-8 py-4">
              ...
              <div className="card-mail flex items-center my-10"></div>
            </div>
          </div>
        </div>
      </>
...
export default AdminFeedbackExpandPage;

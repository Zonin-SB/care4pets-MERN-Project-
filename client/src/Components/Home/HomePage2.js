...
function HomePage2() {
  return (
    ...
    <div className="p-1">
      <h5 className="text-gray-900 text-2xl font-bold mb-2 text-center">Card title</h5>
  ...
  <div className="rounded-lg shadow-lg bg-violet-400 max-w-xs mx-2 my-2">
    ...
    <div className="p-2">
      <h5 className="text-gray-900 text-xl font-bold mb-2 text-center">Card title</h5>
      <p className="text-gray-700 text-base mb-4 text-center">
        Some quick example.
      </p>
      {/* <button type="button" class=" inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">Button</button> */}

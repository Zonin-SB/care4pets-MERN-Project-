...
import { approveVideo, deleteVideo, getVideoDetails } from '../../Axios/Services/AdminServices';
            ...
            <div className="md:inline-flex w-full space-y-4 md:space-y-0 p-8 text-gray-500 items-center">
              <div className="md:w-3/12 text-center md:pl-6">
                {videoDetails.approved?
                  <button onClick={()=>{navigate(`/adminEditVideo/${videoDetails._id}`)}} className="text-white w-full mx-auto max-w-sm rounded-md text-center bg-blue-500 py-2 px-4 inline-flex items-center focus:outline-none md:float-right">
                ...
                :
                <button onClick={()=>{navigate(`/adminRejectVideo/${videoDetails._id}`)}} className="text-white w-full mx-auto max-w-sm rounded-md text-center bg-red-400 py-2 px-4 inline-flex items-center focus:outline-none md:float-right">
              ...
              <div className="md:w-3/12 text-center md:pl-6">
                {videoDetails.approved?
                <button
                onClick={() => deleteVid(videoDetails._id)}
               ...
               >
                ...
                :
                <button
                 onClick={() => accept(videoDetails._id)}
